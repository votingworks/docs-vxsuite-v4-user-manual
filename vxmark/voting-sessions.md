...
{% hint style="warning" %}
If the voter wants to make changes to their ballot after it has printed, they will have to complete a new voting session. The previous ballot must be spoiled.
{% endhint %}
