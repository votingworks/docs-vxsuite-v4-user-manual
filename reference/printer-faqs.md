...
You may also try adjusting the default paper type. Navigate through the following options on the printer LCD screen:

1. Setup
2. Tray Management
3. Default Paper Type
4. Mid-Weight 96-110g

Although printing is slower with this setting, it will often fix print quality issues.

If after all of the above you continue to have issues, the toner cartridge may be defective and may need to be replaced.
