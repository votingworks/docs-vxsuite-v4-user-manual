...
1. [Save the election package](https://app.gitbook.com/s/JtZutzGTdCzsGITrdiph/vxadmin-system-setup/save-election-package) to a USB drive
2. [Create an election manager card](https://app.gitbook.com/s/JtZutzGTdCzsGITrdiph/vxadmin-system-setup/programming-cards)
...
<div><figure><img src="../.gitbook/assets/VxPrint-configuration-LoadElectionPackage1.png" alt=""><figcaption></figcaption></figure> <figure><img src="../.gitbook/assets/VxPrint-configuration-LoadElectionPackage2.png" alt=""><figcaption></figcaption></figure> <figure><img src="../.gitbook/assets/VxPrint-configuration-LoadElectionPackage3.png" alt=""><figcaption></figcaption></figure></div>

## Selecting a Polling Place

VxPrint can be configured to print ballots only for a specific precinct . Use the `Select a Polling Space...`  dropdown to choose a precinct.

Note that the precinct setting only limits the options for poll workers. Election managers, on the other hand, are always able to print all ballot styles.

<figure><img src="../.gitbook/assets/VxPrint-configuration-selectapollplace (1).png" alt="" width="375"><figcaption></figcaption></figure>

{% hint style="info" %}
If your election package defines only one precinct, there is no need to select a precinct and the `Select a Polling Place...` dropdown will not be visible.&#x20;
{% endhint %}
...
<div><figure><img src="../.gitbook/assets/VxPrint-configuration-ChangeBallotMode1.png" alt=""><figcaption></figcaption></figure> <figure><img src="../.gitbook/assets/VxPrint-configuration-ChangeBallotMode2.png" alt=""><figcaption></figcaption></figure></div>
...
<div><figure><img src="../.gitbook/assets/VxPrint-configuration-RemoveConfigData1.png" alt=""><figcaption></figcaption></figure> <figure><img src="../.gitbook/assets/VxPrint-configuration-RemoveConfigData2.png" alt=""><figcaption></figcaption></figure></div>
...
<figure><img src="../.gitbook/assets/VxPrint-settings.jpg" alt=""><figcaption></figcaption></figure>
